...
races_df = spark.read.parquet(f"{processed_folder_path}/races")\
    ...
    .withColumnRenamed("race_timestamp","race_acc_date")
...
races_circuit_df = races_df.join(circuits_df, races_df.circuit_id == circuits_df.circuit_id, "inner")\
    .select(races_df.race_id, races_df.race_year, races_df.race_name, races_df.race_acc_date, circuits_df.circuit_location)
...
final_df = race_results_df.select("race_id","race_year","race_name","circuit_location","driver_name","driver_number",
...
overwrite_partition(final_df,"f1_presentation_","race_result","race_id")